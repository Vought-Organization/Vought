...
function HotSite() {
  async function downloadTxt() {
    ...
    events
      .get('http://54.163.233.38:8080/v1/events/export-eventos')
      .then((response) => {
  ...
  async function importTxt() {
    ...
    events
      .get('http://54.163.233.38:8080/v1/events/import-eventos')
      .then((response) => {
        console.log(response.data);
      ...
      <div className="banner">
        <div className="bg">
          ...
          <div className="content">
            ...
            <button onClick={() => importTxt()} className="btn">
              {' '}
              Importar Dados
            </button>
          </div>
          <div className="search_box">
            <div className="input_bx">
              <p>
                Quer saber mais sobre os seus eventos e os participantes? Click
                no botão acima, e descubra um ramo de possibilidades em que você
                jamais viu!
              </p>
            </div>
          </div>
